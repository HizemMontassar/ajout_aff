...
create_window6 (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed6), textview1, 0, 32);
  gtk_widget_set_size_request (textview1, 448, 360);

  label26 = gtk_label_new (_("Afficher Utilisateur "));
  gtk_widget_show (label26);
  gtk_fixed_put (GTK_FIXED (fixed6), label26, 104, 0);
  gtk_widget_set_size_request (label26, 208, 24);

  button9 = gtk_button_new ();
  gtk_widget_show (button9);
  gtk_fixed_put (GTK_FIXED (fixed6), button9, 480, 136);
  ...
  GLADE_HOOKUP_OBJECT (window6, alignment9, "alignment9");
  GLADE_HOOKUP_OBJECT (window6, hbox9, "hbox9");
  GLADE_HOOKUP_OBJECT (window6, image9, "image9");
